...
public interface IMoney {
	...
	/**
	 * Append this to a MoneyBag m. appendTo() needs to be public because it is used
	 * polymorphically, but it should not be used by clients because it modifies the
	 * argument m.
	 */
